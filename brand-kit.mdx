...
<Card title="Owly Brand Kit (Complete)" icon="download" href="https://raw.githubusercontent.com/owlyfi/docs/main/images/Brand-Kit/Owly-Brand-Kit.zip">
...
<CardGroup cols={2}>
  ...
  <Card title="Green Square Logo">
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '1rem' }}>
      <img src="https://owly.fi/docs/images/Brand-Kit/Owly-logo-green-square.svg" style={{ height: '120px', marginBottom: '1rem' }} />
      <div style={{ display: 'flex', gap: '1rem' }}>
        <a href="https://owly.fi/docs/images/Brand-Kit/Owly-logo-green-square.svg" download>Download</a>
        <span>·</span>
        <a href="https://owly.fi/docs/images/Brand-Kit/Owly-logo-green-square.svg" target="_blank">Open</a>
      </div>
    </div>
  </Card>
