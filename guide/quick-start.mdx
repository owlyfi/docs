...
<Check>Basic understanding of perpetual futures trading</Check>
...
Your copy trading funds will be held in a dedicated Hyperliquid sub-account.
...
<Steps>
  ...
  <Step title="Configure Settings">
    Set your copy ratio and risk parameters.
  </Step>
  <Step title="Confirm">
