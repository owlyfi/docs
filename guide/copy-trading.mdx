...
The Discovery page helps you find traders to copy:
...
<CardGroup cols={2}>
  ...
  <Card title="Favorites" icon="star">
    Save traders for later comparison.
  </Card>
</CardGroup>
...
|--------|------------------|
| **30D ROI** | Consistent positive returns |
| **Max Drawdown** | Lower is generally safer |
| **Win Rate** | > 50% combined with good risk/reward |
| **Trade Frequency** | Matches your preferred activity level |
| **Account Age** | Longer track record = more reliable data |
...
<Steps>
  ...
  <Step title="Configure Risk Settings">
    Set your stop-loss, max leverage, and position limits.
  </Step>
  <Step title="Confirm">
